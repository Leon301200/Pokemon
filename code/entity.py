...
class Entity(pygame.sprite.Sprite):
    ...
    def __init__(self, keylistener: KeyListener, screen: Screen, x: int, y: int):
        ...
        self.spritesheet = pygame.image.load("assets/sprite/hero_01_red_m_walk.png").convert_alpha()
    ...
    def get_all_images(self):
        ...
        heigth: int = self.spritesheet.get_height() // 4

        for i in range(4):
            for j, key in enumerate(all_images.keys()):
                all_images[key].append(Tool.split_image(self.spritesheet, i * width, j * heigth, width, heigth))
        return all_images
